...
namespace RefinedDigital\PaymentGatewayCybersource\Module\Providers;
...
class PaymentGatewayCybersourceServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        app(PaymentGatewayAggregate::class)
            ->addGateway('Cybersource', \RefinedDigital\PaymentGatewayCybersource\Module\Classes\Cybersource::class);
    }
}
